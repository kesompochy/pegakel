...
const translateClickPositionToSpritePosition = (canvas: HTMLCanvasElement, event: MouseEvent, spriteWidth: number, spriteHeight: number): {x: number | undefined, y: number | undefined} => {
